...
('I can accept failure, everyone fails at something. But I cannot accept not trying.', 3, 2),
('Do not count the days, make the days count.', 4, 2),
('You miss 100% of the shots you do not take.', 5, 2),
...
('If you want the rainbow, you have to put up with the rain.', 10, 1),
('I will not be a rock star. I will be a legend.', 11, 1),
...
('It is not over till it is over.', 15, 3),
('I have not slept for ten days, because that would be too long.', 16, 3),
...
('Life is what happens when you are busy making other plans.', 19, 4),
('Without music, life would be a mistake.', 19, 1),
('If you are going through hell, keep going.', 19, 4),
('People say nothing is impossible, but I do nothing every day.', 19, 3),
('Hard work beats talent when talent does not work hard.', 19, 2),
('Music can change the world because it can change people.', 1, 1),
('I have failed over and over again in my life. And that is why I succeed.', 3, 2),
('The best way to predict the future is to create it.', 19, 4),
('I am not superstitious, but I am a little stitious.', 19, 3),
...
('Believe you can and you are halfway there.', 19, 5),
